...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="{{url('/')}}/dist/img/logorefaat.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="box-shadow: none !important;">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <i class="nav-icon fas fas fa-light fa-users"></i>
              <p>
                Users
                <span class="badge badge-info right">
                <?php   
                $user_no = count(\App\Models\User::get());
                ?>
                {{$user_no}}
                </span>
              </p>
          ...
          <li class="nav-item">
            ...
            <i class="nav-icon fas fa-camera-retro"></i>
              <p>
                ...
                <span class="badge badge-info right">
                <?php   
                $album_no = count(\App\Models\Album::get());
                ?>
                {{$album_no}}
                </span>
              </p>
