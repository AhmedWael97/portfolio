          ...
          <div class="col-lg-12">
              ...
              <div class="card-body">
                ...
                <thead>
                  ...
                  <tbody>
                  @foreach($clients_section as $key=>$client_section)
                    <tr>
                    <td>{{++$key}}</td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Clients Images Sections Images</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="{{route('save-clients-image')}}" method="post" method="post" enctype="multipart/form-data">
      @csrf
      <div class="modal-body">
      <div class="col-lg-6">
            <label for="example-fileinput"
                class="form-label">Clients Section Images</label>
